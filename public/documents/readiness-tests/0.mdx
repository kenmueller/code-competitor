...
export const title = 'Are you ready for level 0? | Code Competitor'

# Are you ready for level 0?

> Level 0 is for students that have never programmed before, or have programmed but not in the C++ programming language.
